...
from input_data import preprocess_data, load_metr_data, load_los_data
...
flags.DEFINE_integer('training_epoch', 80, 'Number of epochs to train.')
...
flags.DEFINE_string('dataset', 'los', 'los-loop dataset')
...
###### load data ######
data, adj = load_los_data(data_name)
...
out = 'out0withdynp3/%s'%(model_name)
